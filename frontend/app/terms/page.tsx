  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          To use the Platform, you must be at least 18 years old and have the legal capacity to enter into contracts. By using the Platform, you represent and warrant that you meet these requirements.
        </p>
        <p>
          Professionals must possess the necessary licenses, certifications, and qualifications required for their trade or profession in their jurisdiction.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          You agree to use the Platform in a lawful and respectful manner. Prohibited activities include, but are not limited to:
        </p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">6. Service Listings and Job Requests</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p>
          Users are responsible for any taxes, duties, or additional charges related to payments.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">8. Cancellations and Refund Policy</h2>
        <p className="mb-4">
          Clients and Professionals may cancel jobs subject to the Platform&apos;s cancellation policy, which will be communicated at the time of booking.
        </p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">9. Ratings and Reviews Policy</h2>
        <p className="mb-4">
