    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li>Profile information for Professionals (skills, certifications, experience)</li>
          <li>Payment information (processed through third-party providers)</li>
          <li>Service request details and job descriptions</li>
        </ul>
        <h3 className="text-xl font-medium mb-2">Usage Information</h3>
        <p className="mb-4">
          We automatically collect certain information about your device and usage of the Platform:
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li>IP address, browser type, and device information</li>
          <li>Pages visited, time spent on the Platform, and click patterns</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>To facilitate connections between Clients and Professionals</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li><strong>With Other Users:</strong> Clients and Professionals share necessary information to complete service transactions</li>
          <li><strong>Service Providers:</strong> Third-party vendors who assist us in operating the Platform (payment processors, hosting services)</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We use cookies and similar technologies to enhance your experience on the Platform. Cookies are small text files stored on your device that help us:
        </p>
        <ul className="list-disc list-inside space-y-2 mb-4">
        ...
        <p>
          You can control cookie settings through your browser preferences. However, disabling cookies may affect the functionality of the Platform.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          The Platform is not intended for children under 18 years of age. We do not knowingly collect personal information from children under 18. If we become aware that we have collected such information, we will take steps to delete it promptly.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mt-4">
          For data protection inquiries specific to Nigeria, you may also contact the National Information Technology Development Agency (NITDA) at [relevant contact information].
        </p>
      </section>
    </div>
  );
