...
interface Job {
  ...
  longitude: number;
  skills: string;
  distance?: number;        // ← Added: Distance from server
}
      ...
      <div className="relative h-48 bg-gray-100 dark:bg-gray-800 overflow-hidden">
        ...
        {job.distance && (
          <div className="absolute top-4 right-4">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-2xl bg-blue-700 text-white text-xs font-medium">
